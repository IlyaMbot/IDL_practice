...
original2 = readfits(file2, header2)
...
rsl2 = sxpar(header2, 'CDELT1') ;resolution 
size21 = round(sxpar(header2, 'NAXIS1') * rsl2/ rsl)
print, rsl, rsl2

original2 = congrid(original2, size21, size21)

;original2 = ROT(original2, 0.0, 1, cpx, cpy)
original2 = ROT(original2, 180, 1 , var, var1)
...
p1 = original2((x * size2) : (x1 * size2), (y * size2) : (y1 * size2))
...
p = congrid(p, px1, py1)
tvscl, p, xsize = xsize1, ysize = ysize1, xshift, yshift
